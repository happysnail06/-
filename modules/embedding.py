...
class EmbeddingHandler:
    def __init__(self):
        ...
        self.model = AutoModel.from_pretrained("sentence-transformers/all-MiniLM-L12-v2").to(self.device)
    ...
    def insert_data_into_faiss(self, data):
        vectors = np.array([self.get_embedding(d["documents"]) for d in tqdm(data)])
